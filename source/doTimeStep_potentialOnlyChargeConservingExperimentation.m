function [deltaPhi] = doTimeStep_potentialOnlyChargeConservingExperimentation(dxC, dxF, dyC, dyF, dzC, dzF, dt, ...
    nSpecies, fields3DStar, deltaFields, fields3DOld, isFrontNoFluxCondition, isBackNoFluxCondition, isLeftNoFluxCondition, isRightNoFluxCondition, isBottomNoFluxCondition, isTopNoFluxCondition, ...
...
for iterIndex = 1:nIter
    ...
    for sIndex = 1:nSpecies
        ...
        RHSMatrix = RHSMatrix ...
            ...
            %- poro(1)/dt * vale(1, sIndex) * e * (fields3DStar(2*nVar:nVar:end-nVar, 2:end-1, 2:end-1) + deltaFields(2*nVar:nVar:end-nVar, 2:end-1, 2:end-1) - fields3DOld(2*nVar:nVar:end-nVar, 2:end-1, 2:end-1));
...
%         disp(['Numerical production current: ' num2str(numericalCurrent) ' A'])
    ...
    fields3DStar((nSpecies+1):nSpecies+1:end, 2:end-1, 2:end-1) = fields3DStar(nSpecies+1:nSpecies+1:end, 2:end-1, 2:end-1) + deltaPhi;
