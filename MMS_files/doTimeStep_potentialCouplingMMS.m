function [deltaPhi, residualNorm] = doTimeStep_potentialCoupling(dxC, dxF, dyC, dyF, dzC, dzF, dt, dtPreviousTimeStep, dtPrevPrevTimeStep, ...
    nSpecies, fields3DStar, fields3DOld, fields3DOldOld, fields3DOldOldOld, isFrontNoFluxCondition, isBackNoFluxCondition, isLeftNoFluxCondition, isRightNoFluxCondition, isBottomNoFluxCondition, isTopNoFluxCondition, ...
    constants, yLeftBCVec, yRightBCVec, zBottomBCVec, zTopBCVec, faradaicRxnInfo, isNeutralGas, yRightElectrolyteOverride, bulkElectrolyteL, bulkElectrolyteC, nIter, debugMode, stepCtr, mmsForcing)
...
% Add MMS forcing
RHSMatrix = RHSMatrix + mmsForcing;
