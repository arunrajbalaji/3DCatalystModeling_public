function [dxStripConcentrationOnly, t, residual, A] = doTimeStep_concentrationCoupling(dxC, dxF, nSpecies, xStripMiddle, xStripOld, xStripOldOld, xStripOldOldOld, isFrontNoFluxCondition, isBackNoFluxCondition,  ...
    t, dt, dtPreviousTimeStep, dtPrevPrevTimeStep, constants, faradaicRxnInfo, isNeutralGas, faradaicRxnSourceTermsStrip, faradaicRxnSourceTermsStrip_init, transportRHSTermsStrip, transportRHSTermsStrip_init, stepCtr, debugMode, mmsForcing)
